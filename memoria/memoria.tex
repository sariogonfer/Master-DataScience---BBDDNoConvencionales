...
\fancyhead[RO,RE]{\includegraphics[width=0.5cm,height=0.5cm]{Portada/DSLab_logo_2.png}}
...
\input{Sections/MongoDB/Introduccion}
\input{Sections/MongoDB/Diseno}
\input{Sections/MongoDB/Analisis}
%\input{Sections/Neo4j/Introduccion}
%\input{Sections/Neo4j/Diseno}
%\input{Sections/Neo4j/Analisis}

\input{Extra/Conclusiones}
...
\input{Sections/Appendices/Appendice}
\end{appendices}
